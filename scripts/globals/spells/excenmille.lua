...
function onMagicCastingCheck(caster,target,spell)
	...
	elseif ((bf ~= nil) and (((bf:getBcnmID() > 1378) and (bf:getBcnmID() < 1387)) or (bf:getBcnmID() == 1377))) then
	...
	elseif (bf == nil and (zone == 139 or zone == 144 or zone == 146 or zone == 206)) then
	  caster:PrintToPlayer("Excenmille cannot be summoned outside a BC fight.",0xD);
