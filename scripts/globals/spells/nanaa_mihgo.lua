...
function onMagicCastingCheck(caster,target,spell)
	...
	elseif ((bf ~= nil) and (((bf:getBcnmID() > 1382) and (bf:getBcnmID() < 1387)) or ((bf:getBcnmID() > 1376) and (bf:getBcnmID() < 1382)))) then	
	...
	elseif (bf == nil and (zone == 139 or zone == 144 or zone == 146 or zone == 206)) then
	    caster:PrintToPlayer("Nanaa Mihgo cannot be summoned outside a BC fight.",0xD);
	    return MSGBASIC_CANT_BE_USED_IN_AREA;		
