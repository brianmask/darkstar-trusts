...
function onUseWeaponSkill(player, target, wsID)
	...
	if (USE_ADOULIN_WEAPON_SKILL_CHANGES == true) then
		...
		params.str_wsc = 0.70; params.dex_wsc = 0.0; params.vit_wsc = 0.0; params.agi_wsc = 0.0; params.int_wsc = 0.0; params.mnd_wsc = 0.0; params.chr_wsc = 0.0;
		params.atkmulti = 1.20
	end
